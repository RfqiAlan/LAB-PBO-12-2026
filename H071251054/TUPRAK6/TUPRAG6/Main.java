...
public class Main {
    ...
    private static void tambahItem() {
        ...
        try {
            ...
            if (jenis.equals("1")) {
                ...
                System.out.println(library.addItem(book)); // Akan menangkap error jika ID sama
            } else if (jenis.equals("2")) {
                System.out.print("Masukkan durasi (menit): ");
                int duration = Integer.parseInt(scanner.nextLine().trim());
                DVD dvd = new DVD(title, itemId, duration);
                System.out.println(library.addItem(dvd)); // Akan menangkap error jika ID sama
            } else {
            ...
            System.out.println(e.getMessage()); // Menampilkan pesan error ID duplikat
        }
    }
    ...
    private static void tambahAnggota() {
        ...
        try {
            ...
            System.out.println(library.addMember(member)); // Akan menangkap error jika ID sama
        } catch (NumberFormatException e) {
            System.out.println("Input tidak valid. Harap masukkan angka yang benar.");
        } catch (IllegalArgumentException e) {
            System.out.println(e.getMessage()); // Menampilkan pesan error ID duplikat
    ...
    private static void lihatItemDipinjamAnggota() {
        ...
        try {
            ...
            if (member == null) {
                System.out.println("Error: Member dengan ID " + memberId + " tidak ditemukan.");
                return;
            }
