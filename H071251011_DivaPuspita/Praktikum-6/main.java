...
public class main {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            while (true) {
                try {
                    pilih = Integer.parseInt(a.nextLine());
                    break;
                ...
                switch (pilih) {
                    ...
                    case 1:
                        ...
                        while (true) {
                            ...
                            try {
                                itemId = Integer.parseInt(a.nextLine());
                        ...
                        try {
                            ...
                            while (true) {
                                ...
                                try {
                                    durasi = Integer.parseInt(a.nextLine());
                                    break;
                                } catch (NumberFormatException e) {
                    ...
                    case 2:
                        ...
                        while (true) {
                            ...
                            try {
                                mid = Integer.parseInt(a.nextLine());
                                break;
                            } catch (NumberFormatException e) {
                    ...
                    case 3:
                        ...
                        while (true) {
                            System.out.print("Item ID: ");
                            try {
                                iId = Integer.parseInt(a.nextLine());
                                break;
                            } catch (NumberFormatException e) {
                        ...
                        while (true) {
                            ...
                            try {
                                days = Integer.parseInt(a.nextLine());
                                break;
                            } catch (NumberFormatException e) {
                    ...
                    case 4:
                        ...
                        while (true) {
                            System.out.print("Member ID: ");
                            try {
                                mId2 = Integer.parseInt(a.nextLine());
                                break;
                            } catch (NumberFormatException e) {
                                System.out.println("MEMBER ID HARUS ANGKA!! Ulangi input.\n");
                            }
                        ...
                        while (true) {
                            System.out.print("Item ID: ");
                            try {
                                iId2 = Integer.parseInt(a.nextLine());
                                break;
                            } catch (NumberFormatException e) {
                                System.out.println("ITEM ID HARUS ANGKA!! Ulangi input.\n");
                            }
                        ...
                        while (true) {
                            ...
                            try {
                                late = Integer.parseInt(a.nextLine());
                                break;
                            } catch (NumberFormatException e) {
                    ...
                    case 7:
                        ...
                        while (true) {
                            System.out.print("Member ID: ");
                            try {
                                mId3 = Integer.parseInt(a.nextLine());
                                break;
                            } catch (NumberFormatException e) {
                                System.out.println("MEMBER ID HARUS ANGKA!! Ulangi input.\n");
                            }
